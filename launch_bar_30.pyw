...
#------------------ set command path ----o
        ...
        self.command = ("python3 /home/bill/programming/charts_qt/mem_3.py")
...
#------------
        ...
        file = open("//home//bill//Launch_bar//launch_variables.py", "w")
        file.write("\r\n" + "command_1_text = str('{}') ".format(self.command_1_text));
        file.close()


        file = open("//home//bill//Launch_bar//launch_variables.py", "a")
...
##        print('self.icon_3_text', self.icon_3_text)
        self.button_1.setIcon(QIcon(self.icon_1_text))
        self.button_2.setIcon(QIcon(self.icon_2_text))
        self.button_3.setIcon(QIcon(self.icon_3_text))
        self.button_4.setIcon(QIcon(self.icon_4_text))
...
##        gksudo = ('gksudo')
##        string = QString = gksudo
##        QString = ("dpkg_command = 'pkexec dpkg -i mydeb.deb'");
##        QString = 'gksu ' + self.command_1_text
##        string.append(gksudo)
##        print(QString)
        self.process_1 = QProcess()
##        my_string = (QString)
##        os.system(QString)
        self.process_1.execute(self.command_1_text)
    def button_2__(self):
        print('button_2__')
        self.process_2 = QProcess()
        self.process_2.start(self.command_2_text)
    def button_3__(self):
        print('button_3__')
        self.process_3 = QProcess()
        self.process_3.start(self.command_3_text)
    def button_4__(self):
        print('button_4__')
        self.process_4 = QProcess()
        self.process_4.start(self.command_4_text)
    def button_5__(self):
        print('button_5__')
        self.process_5 = QProcess()
        self.process_5.start(self.command_5_text)
    def button_6__(self):
        print('button_6__')
        self.process = QProcess()
    ...
    def initGUI(self):
        ...
        self.move(10,275)
        self.resize(100, 600)
        self.setWindowTitle('launch_bar')
